...
void main(List<String> args) async {
  ...
  // var contents = await myFile.readAsLines(encoding: utf8);
  // print(contents);
  // List<String> lines;
}
...
//   String codes = """ import 'package:flutter/material.dart';
...
//   int wordCounter = 0;
//   String word = "class";
//   List<String> words = codes.split(" ");

//   words.where((w) => w.contains(word)).forEach((w) => wordCounter++);
